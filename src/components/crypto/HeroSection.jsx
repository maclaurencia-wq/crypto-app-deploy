        ...
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 md:gap-10 items-center">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center gap-6 sm:gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <Link
                to="/signup"
                className="bg-blue-600 text-white rounded-full py-2.5 sm:py-3 px-5 sm:px-6 font-bold text-sm sm:text-base whitespace-nowrap hover:bg-blue-700 transition-colors shadow-md inline-block text-center"
              >
                Sign Up
              </Link>
            </div>
